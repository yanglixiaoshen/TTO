...
def get_train_config():
    ...
    # basic config
    parser.add_argument("--exp-name", type=str, default="TraTransformer", help="experiment name")
    parser.add_argument("--n-gpu", type=int, default=1, help="number of gpus to use")
    ...
    parser.add_argument("--num-workers", type=int, default=8, help="number of workers")
    parser.add_argument("--train-steps", type=int, default=10000000, help="number of training/fine-tunning steps")
    ...
    parser.add_argument("--dataset", type=str, default='ImageNet', help="dataset for fine-tunning/evaluation")
    parser.add_argument("--num-classes", type=int, default=1000, help="number of classes in dataset")
    parser.add_argument("--num-viewport", type=int, default=249, help="number of viewport per ODI")
    parser.add_argument("--num-decLayer", type=int, default=6, help="number of viewport per ODI")

    parser.add_argument("--train_img_dir", type=str, default='/home/yl/dataset_traTransm/train_transformer_img_resize', help='data folder')
    parser.add_argument("--test_img_dir", type=str, default='/home/yl/dataset_traTransm/test_transformer_img_resize', help='data folder')
    parser.add_argument("--train_gt_dir", type=str, default='/home/yl/dataset_traTransm/gt_train_norm', help='data folder')
    parser.add_argument("--test_gt_dir", type=str, default='/home/yl/dataset_traTransm/gt_test_norm', help='data folder')
    parser.add_argument("--train_id", type=str, default='/home/yl/dataset_traTransm/trans_train_id.txt',
                        help='data folder')
    parser.add_argument("--test_id", type=str, default='/home/yl/dataset_traTransm/trans_test_id.txt',
                        help='data folder')


# 12 6 4 TraTransformer_ImageNet_bs4_lr0.001_wd0.0001_210604_011804
# 6 6 4
